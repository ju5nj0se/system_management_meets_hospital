...
public class MeetController : Controller
{
    ...
    [HttpPost]
    public IActionResult Create(AdminMeetVM vm)
    {
        ...
        {
            ModelState.AddModelError("StartTimeDate", "La hora de inicio debe ser menor a la hora de fin.");
            ViewBag.Doctors = new SelectList(_context.Doctors, "Id", "Name");
            return View(vm);
        }
    ...
    [HttpPost]
    public IActionResult Update(AdminMeetVM vm)
{
